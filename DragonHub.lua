...
local bearlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/qng96/main/refs/heads/main/mainHL.lua"))()
local Window = bearlib:MakeWindow({
    Title = "Dragon Hub",
    SubTitle = "Blox Fruit",
    SaveFolder = true,
    Image = "93133335012077"
})
...
task.spawn(function()
    ...
    bearlib:Notify({
        Title = "Dragon Hub",
        Message = "Script load thành công",
        Duration = 10
    })
end)
...
v0:AddProfile({
    Name = "HLuuVN ☑",             
    Bio = "22-11-1995", 
    Avatar = "rbxassetid://96915566851000", 
    Cover = "rbxassetid://105102363306887", 
    Verified = true 
})
v0:AddSingleDiscordCard({
"Dragon Hub 🇻🇳",
        "Theo dõi kênh TikTok của chúng tôi để cập nhật thông tin mới nhất",
        "rbxassetid://96915566851000",
        "rbxassetid://105102363306887",
        2000,
        10000,
        "https://www.tiktok.com/@hluuvngaming"
})

v0:AddParagraph({
    "Thông báo",
    "•Dragon Hub\n• Script tạo bởi HLuuVN\n• Ngày tạo: 13-05-2026\n• Ngày cập nhật lần cuối: 13-05-20266\n• Aura gun hiện chưa bắn được thuyền và leviathan"
})
...
local discordContainer = v0:AddDiscordInvite({
    -- Card 1
    {
        "TikTok(Đang cập nhập)",
        "Theo dõi kênh TikTok của chúng tôi để cập nhật thông tin mới nhất!",
        "rbxassetid://93133335012077",
        "rbxassetid://105102363306887",
        500,
        1500,
        ""
    ...
    -- Card 2
    {
        "Discord(Đang cập nhập)",
        "Tham gia nhóm Discord để cập nhật những thông báo mới nhất.",
        "rbxassetid://93133335012077",
        "rbxassetid://105102363306887",
        250,
        1000,
...
-- =========================================================
-- AUTO FISHING SYSTEM (Ported from Dragon Hub)
-- =========================================================
        ...
        pcall(function()
            while wait(Sec) do
                if _G.Auto_Rainbow_Haki then
                    -- Copy logic Rainbow Haki từ file Dragon hub.txt (dòng 2058-2154) vào đây nếu cần
...
-- ========================================
-- AUTO SAW SWORD (WORLD 1) - từ Dragon Hub
-- ========================================
if World1 then
    v3:AddToggle({
        Name = "Auto Saw Sword",
...
v15:AddButton({
    ...
    Callback = function()
        task.spawn(function()
            local fruitModel = game:GetObjects("rbxassetid://93133335012077")[1]
